...
public class ColorScheme {
    ...
    public void setThemeFromContext(Context ctx) {
        ...
        opersBorderColor = colorForAttribute(ctx, R.attr.opersBorderColor);
        ownersBorderColor = colorForAttribute(ctx, R.attr.ownersBorderColor);
        adminsBorderColor = colorForAttribute(ctx, R.attr.adminsBorderColor);
        opsBorderColor = colorForAttribute(ctx, R.attr.opsBorderColor);
        halfopsBorderColor = colorForAttribute(ctx, R.attr.halfopsBorderColor);
        voicedBorderColor = colorForAttribute(ctx, R.attr.voicedBorderColor);
        membersBorderColor = colorForAttribute(ctx, R.attr.membersBorderColor);
    ...
    public int opersBorderColor;
    public int ownersBorderColor;
    public int adminsBorderColor;
    public int opsBorderColor;
    public int halfopsBorderColor;
    public int voicedBorderColor;
    public int membersBorderColor;
