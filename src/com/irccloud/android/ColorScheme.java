...
public class ColorScheme {
    ...
    public void setThemeFromContext(Context ctx, String theme_name) {
        ...
        bufferTextColor = resourceForAttribute(ctx, R.attr.bufferTextColor);
        inactiveBufferTextColor = resourceForAttribute(ctx, R.attr.inactiveBufferTextColor);
        unreadBufferTextColor = resourceForAttribute(ctx, R.attr.unreadBufferTextColor);
        selectedBufferTextColor = resourceForAttribute(ctx, R.attr.selectedBufferTextColor);
        ...
        archivesHeadingTextColor = resourceForAttribute(ctx, R.attr.archivesHeadingTextColor);
        archivedChannelTextColor = resourceForAttribute(ctx, R.attr.archivedChannelTextColor);
        archivedBufferTextColor = resourceForAttribute(ctx, R.attr.archivedBufferTextColor);
        selectedArchivesHeadingColor = resourceForAttribute(ctx, R.attr.selectedArchivesHeadingColor);
