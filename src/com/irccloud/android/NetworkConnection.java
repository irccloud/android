		...
		if(type != null && type.length() > 0) {
			...
			if(type.equalsIgnoreCase("header")) {
				...
				if(!backlog)
                    ...
                    || type.equalsIgnoreCase("btn_metadata_set") || type.equalsIgnoreCase("sasl_success") || type.equalsIgnoreCase("cap_ls") || type.equalsIgnoreCase("cap_req") || type.equalsIgnoreCase("cap_ack")) {
